...
export default function ProjectsRegistryClient({ initialProjects }: ProjectsRegistryClientProps) {
    ...
    return (
      <div className="px-6">
        <div className="bg-blue-50 border border-blue-200 rounded-md p-6">
          <h3 className="text-sm font-medium text-blue-800 mb-2">Žádné servisní projekty</h3>
  ...
  return (
    <div className="px-6">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900">Evidence projektů</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {serviceProjects.map((project, index) => (
          <div key={`${project.doklad_proj || 'no-id'}-${project.nazev || 'no-name'}-${index}`} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6">
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
              <div className="grid grid-cols-2 gap-2">
                <button 
                  ...
                  className="flex items-center justify-center px-3 py-2 text-sm bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors"
                >
