...
export default function DatabaseDetailRow({ database, isOpen, onToggle }: DatabaseDetailRowProps) {
  ...
  const fetchChartData = async () => {
    try {
      ...
      // Rozdělení dat na DB a Log pro dva samostatné grafy
      ...
      setChartData({ db: [], log: [] })
        ...
        },
        {
          ...
          data: Array.from({ length: 30 }, (_, i) => ({
            ...
            y: database.velikost_volne + Math.floor(Math.random() * 50 - 25)
          }))
        }
      ]
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <DataChart
              ...
              showGrid={true}
              xAxisLabel="Datum"
              yAxisLabel="Velikost (MB) / Využití (%)"
            />
