...
export default function GlobalniVyhledavani() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex-1 max-w-xl" aria-label="Vyhledávání na portálu">
