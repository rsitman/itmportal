    ...
    <div className="overflow-x-auto">
      <div className="w-full">
        ...
        <div className="flex border-b border-gray-200 bg-gray-50 text-xs font-medium text-gray-500">
          <div className="px-4 py-3 border-r border-gray-200 w-[180px] flex-shrink-0">Projekt</div>
          <div className="px-6 py-3 border-r border-gray-200 flex-grow min-w-[300px]">Název</div>
        ...
        {upgrades.map((upgrade, index) => (
          <Fragment key={`${upgrade.projekt}-${index}`}>
            <div className="flex border-b border-gray-100 hover:bg-gray-50 flex-shrink-0">
              {/* Project */}
              <div className="px-4 py-3 text-sm font-medium text-gray-900 w-[180px] flex-shrink-0">
              ...
              {/* Name */}
              <div className="px-6 py-3 text-sm text-gray-900 flex-grow min-w-[300px]">
              ...
              {/* Version */}
              <div className="px-4 py-3 text-sm text-gray-900 w-[100px] flex-shrink-0">
                {upgrade.verze}
              </div>
              
              {/* Date From */}
              <div className="px-6 py-3 text-sm text-gray-900 w-[180px] flex-shrink-0">
              ...
              {/* Resolver */}
              <div className="px-6 py-3 text-sm text-gray-900 w-[200px] flex-shrink-0">
              ...
              {/* JIRA */}
              <div className="px-6 py-3 text-sm border-b border-gray-100 w-[150px] flex-shrink-0">
                <a
                  href={`https://your-jira-instance.com/browse/${upgrade.jira_klic}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:text-blue-800 hover:underline font-mono text-xs block"
                >
                  {upgrade.jira_klic}
                </a>
              </div>
