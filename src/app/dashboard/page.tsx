      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          <div className="card-professional">
            ...
            <div className="bg-gray-800 px-4 py-3 border-t border-gray-700">
              <div className="text-sm">
                <a href="/plan_patchovani" className="font-medium text-blue-400 hover:text-blue-300">
          ...
          <div className="card-professional">
            ...
            <div className="bg-gray-800 px-4 py-3 border-t border-gray-700">
              <div className="text-sm">
                <a href="/grafy/db-size" className="font-medium text-blue-400 hover:text-blue-300">
                  Zobrazit grafy →
                </a>
              </div>
            </div>
          ...
          <div className="card-professional">
            ...
            <div className="bg-gray-800 px-4 py-3 border-t border-gray-700">
              <div className="text-sm">
                <a href="/calendar" className="font-medium text-blue-400 hover:text-blue-300">
                  Zobrazit kalendář →
                </a>
              </div>
            </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <a
              ...
              className="card-professional p-6 block hover:shadow-md transition-all"
            >
              <h3 className="text-base font-medium text-white">Mapa poboček</h3>
